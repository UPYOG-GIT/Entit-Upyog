...
const useRMCPropertySearch = ({ tenantId, filters, auth,searchedFrom="" }, config = {}) => {
  ...
  const { isLoading, error, data, isSuccess } = useQuery(["propertySearchList", tenantId, filters, auth], () => Digit.PTService.rmcSearch(args), {
...
export default useRMCPropertySearch;
