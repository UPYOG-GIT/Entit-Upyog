...
export const FsmBreadCrumb = ({ location }) => {
  ...
  const crumbs = [
    {
      path: DSO ? "/fsm-ui/citizen/fsm/dso-dashboard" : "/fsm-ui/employee",
      content: t("ES_COMMON_HOME"),
      show: isFsm,
    },
    {
      path: DRIVER ? "/fsm-ui/citizen/fsm/driver-dashboard" : "/fsm-ui/employee",
      content: t("ES_COMMON_HOME"),
      show: isFsm,
    },
    {
      path: isRegistry ? "/fsm-ui/employee/fsm/registry?selectedTabs=VENDOR" : FSTPO ? "/fsm-ui/employee/fsm/fstp-inbox" : "/fsm-ui/employee",
      content: isVehicleLog ? t("ES_TITLE_INBOX") : "FSM",
      show: isFsm,
    },
    {
      path: isNewApplication ? "/fsm-ui/employee/fsm/new-application" : "",
    ...
    {
      path: isInbox || isSearch || isApplicationDetails ? "/fsm-ui/employee/fsm/inbox" : "",
      content: t("ES_TITLE_INBOX"),
      show: (isFsm && isInbox) || isSearch || isApplicationDetails,
    },
    {
      path: "/fsm-ui/employee/fsm/search",
    ...
    {
      path: "fsm-ui/employee/fsm/modify-application/" + id,
...
const EmployeeApp = ({ path, url, userType }) => {
  ...
  const moduleForSomeFSMEmployees =
    !DSO && !COLLECTOR && !FSM_EDITOR
      ? [
          {
            link: "/fsm-ui/employee/fsm/new-application",
  ...
  const moduleForSomeFSMAdmin = FSM_ADMIN
    ? [
        {
          link: "/fsm-ui/employee/fsm/registry",
  ...
  const module = [
    ...
    {
      link: "/fsm-ui/employee/fsm/inbox",
