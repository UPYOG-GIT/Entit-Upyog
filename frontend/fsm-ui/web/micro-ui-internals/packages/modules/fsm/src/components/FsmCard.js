...
const FSMCard = () => {
  ...
  const moduleForSomeFSMAdmin = FSM_ADMIN
    ? [
        {
          link: "/fsm-ui/employee/fsm/registry?selectedTabs=VENDOR",
  ...
  const propsForFSTPO = {
    ...
    //             label: t(key),
    //             count: t(info[key]),
    //             link: "/fsm-ui/employee/fsm/fstp-inbox"
    //         })): [],
    links: [
      /*{
      ...
      },
      {
        ...
        link: "/fsm-ui/employee/fsm/fstp-add-vehicle",
      },
      {
      ...
      }, */
      {
        ...
        link: "/fsm-ui/employee/fsm/fstp-operations",
      },
    ],
  };
