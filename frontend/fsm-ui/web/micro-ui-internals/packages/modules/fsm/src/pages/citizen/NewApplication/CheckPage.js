        ...
        <StatusTable>
          {selectTripNo && selectTripNo?.tripNo && (
            <Row
              ...
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/select-trip-number" />}
            />
          )}
          ...
          {selectGender && (
            <Row
              ...
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/select-gender" />}
            />
          )}
          <Row
            label={t("CS_CHECK_PROPERTY_ID")}
            text={value?.cptId?.id ? value?.cptId?.id : "NA"}
            actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/know-your-property" />}
          />
          <Row
            label={t("CS_CHECK_PROPERTY_TYPE")}
            text={t(propertyType?.i18nKey)}
            actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/property-type" />}
          />
          <Row
            label={t("CS_CHECK_PROPERTY_SUB_TYPE")}
            text={t(subtype?.i18nKey)}
            actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/property-subtype" />}
          />
          <Row
            label={t("CS_CHECK_ADDRESS")}
            text={getAddress(address,t)}
            actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/pincode" />}
          />
          {address?.landmark?.trim() && (
            <Row
              label={t("CS_CHECK_LANDMARK")}
              text={address?.landmark?.trim()}
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/landmark" />}
            />
          )}
          {address?.slumArea?.code === true && (
            <Row
              ...
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/slum-details" />}
            />
          )}
          {pitType && (
            <Row
              ...
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/pit-type" />}
            />
          )}
          ...
          <Row
            ...
            actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/road-details" />}
          />
          <Row
          ...
          {pitMeasurement && (
            <Row
              ...
              text={[pitMeasurement]}
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/tank-size" />}
            />
          )}
          {/* {(selectPaymentPreference?.advanceAmount || selectPaymentPreference?.advanceAmount === 0) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo="/fsm-ui/citizen/fsm/new-application/select-payment-preference" />}
            />
          )} */}
        </StatusTable>
