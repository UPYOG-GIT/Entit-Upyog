...
const DriverDetails = (props) => {
  ...
  useEffect(() => {
    switch (selectedAction) {
      ...
      case "EDIT":
        return history.push("/fsm-ui/employee/fsm/registry/modify-driver/" + dsoId);
      case "HOME":
        return history.push("/fsm-ui/employee/fsm/registry?selectedTabs=DRIVER");
      default:
        break;
    }
  }, [selectedAction]);
  ...
  const handleDeleteDriver = () => {
    ...
    mutateDriver(formData, {
      ...
      onSuccess: (data, variables) => {
        ...
        setTimeout(() => {
          closeToast, history.push(`/fsm-ui/employee/fsm/registry`);
        }, 5000);
      },
    });
    setShowModal(false);
