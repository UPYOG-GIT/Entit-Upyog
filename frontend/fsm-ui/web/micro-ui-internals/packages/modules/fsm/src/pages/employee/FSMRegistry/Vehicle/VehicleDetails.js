...
const VehicleDetails = (props) => {
  ...
  useEffect(() => {
    switch (selectedAction) {
      ...
      case "EDIT":
        return history.push("/fsm-ui/employee/fsm/registry/modify-vehicle/" + vehicleNumber);
      case "HOME":
        return history.push("/fsm-ui/employee/fsm/registry?selectedTabs=VEHICLE");
      default:
        break;
    }
  }, [selectedAction]);
  ...
  const handleDelete = () => {
    ...
    mutate(formData, {
      ...
      onSuccess: (data, variables) => {
        ...
        setTimeout(() => {
          closeToast;
          history.push(`/fsm-ui/employee/fsm/registry`);
        }, 5000);
      },
    });
    setShowModal(false);
