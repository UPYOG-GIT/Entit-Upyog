...
const DesktopInbox = (props) => {
  ...
  function goTo(id) {
    // history.push("/fsm-ui/employee/fsm/complaint/details/" + id);
  }
        ...
        return [
          {
            ...
            Cell: ({ row }) => {
              ...
              return (
                <div>
                  <span className="link">
                    <Link to={"/fsm-ui/employee/fsm/fstp-operator-details/" + row.original["applicationNo"]}> {citizen_info?.applicationNo}</Link>
                  </span>
                </div>
              );
            },
        ...
        return [
          {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={"/fsm-ui/employee/fsm/fstp-operator-details/" + row.original["applicationNo"]}>
          ...
          },
          {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={"/fsm-ui/employee/fsm/fstp-operator-details/" + row.original["applicationNo"]}>{row.original["applicationNo"]}</Link>
                  </span>
                </div>
              );
            },
