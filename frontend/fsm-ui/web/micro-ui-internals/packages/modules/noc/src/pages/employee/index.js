...
const NOCBreadCrumbs = ({ location }) => {
  ...
  const crumbs = [
    ...
    {
      path: "/fsm-ui/employee/noc/inbox",
      content: t("ES_COMMON_INBOX"),
      show: location.pathname.includes("noc/inbox") ? true : false,
    },
    {
      path: "/fsm-ui/employee/noc/inbox/application-overview/:id",
      content: t("NOC_APP_OVER_VIEW_HEADER"),
      show: location.pathname.includes("noc/inbox/application-overview") ? true : false,
    },
    {
      path: "/fsm-ui/employee/noc/search",
      content: t("ES_COMMON_APPLICATION_SEARCH"),
      show: location.pathname.includes("/fsm-ui/employee/noc/search") ? true : false,
    },
    {
      path: "/fsm-ui/employee/noc/search/application-overview/:id",
      content: t("NOC_APP_OVER_VIEW_HEADER"),
      show: location.pathname.includes("/fsm-ui/employee/noc/search/application-overview") ? true : false,
    },
  ];
