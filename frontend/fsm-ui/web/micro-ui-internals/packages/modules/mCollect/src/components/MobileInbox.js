          ...
          return (
            <div>
              <span className="link">
                <Link
                  to={{
                    pathname: `/fsm-ui/employee/payment/collect/${original?.["businessService"]}/${original?.["challanNo"]}/tenantId=${original?.["tenantId"]}?workflow=mcollect`,
                  }}
                >
                  {t(`UC_${action}`)}
                </Link>
      ...
      <div className="inbox-container">
        <div className="filters-container">
          {!isSearch && <ApplicationLinks linkPrefix={parentRoute} allLinks = {[
          {
            ...
            link: "/fsm-ui/employee/mcollect/new-application",
            roles: [],
          }]} 
