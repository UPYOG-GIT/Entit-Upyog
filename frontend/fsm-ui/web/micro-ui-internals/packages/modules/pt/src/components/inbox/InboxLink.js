  ...
  const allLinks = [
    {
      ...
      link: "/fsm-ui/employee/pt/new-application",
      businessService: "PT",
      roles: ["PT_CEMP"],
    },
    {
      text: "PT_SEARCH_PROPERTY",
      link: `/fsm-ui/employee/pt/search`,
      businessService: "PT",
      roles: [],
    },
    {
      text: "ES_COMMON_APPLICATION_SEARCH",
      link: `/fsm-ui/employee/pt/application-search`,
      businessService: "PT",
      roles: [],
    },
    // { text: "PT_REPORTS", hyperLink: true, link: "/fsm-ui/employee/integration/dss/propertytax", roles: [], businessService: "PT" },
    // { text: "PT_DASHBOARD", link: "/fsm-ui/employee/", roles: [], businessService: "PT" },
  ];
