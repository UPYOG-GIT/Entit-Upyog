      ...
      <div>
        ...
        <StatusTable>
          <Row
            ...
            actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/pincode`} />}
          />
          <Row
            ...
            actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/proof`} />}
          />
        </StatusTable>
        ...
        <StatusTable>
          <Row
            ...
            actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/owner-ship-details@0`} />}
          />
        </StatusTable>
        <div>
          {owners &&
                  ...
                  <div>
                    <StatusTable>
                      <Row
                        ...
                        actionButton={
                          <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/inistitution-details/`}${index}`} />
                        }
                      />
                      <Row
                      ...
                      <Row
                        ...
                        actionButton={
                          <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/institutional-owner-address/`}${index}`} />
                        }
                      />
                      <Row
                      ...
                      <Row
                        ...
                        actionButton={
                          <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/institutional-proof-of-identity/`}${index}`} />
                        }
                      />
                    </StatusTable>
                  </div>
                  ...
                  <div>
                    <StatusTable>
                      <Row
                        label={t("PT_OWNER_NAME")}
                        text={`${t(checkForNA(owner?.name))}`}
                        actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/owner-details/`}${index}`} />}
                      />
                      <Row
                      ...
                      <Row
                        ...
                        actionButton={
                          <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/special-owner-category/`}${index}`} />
                        }
                      />
                      <Row
                        label={`${t("PT_OWNERS_ADDRESS")}`}
                        text={`${t(checkForNA(owner?.permanentAddress))}`}
                        actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/owner-address/`}${index}`} />}
                      />
                      <Row
                        label={`${t("PT_COMMON_SAME_AS_PROPERTY_ADDRESS")}`}
                        text={`${t(checkForNA(owner?.isCorrespondenceAddress))}`}
                      ...
                      {owner?.ownerType?.code !== "NONE" ? (
                        <Row
                          ...
                          actionButton={
                            <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/special-owner-category-proof/`}${index}`} />
                          }
                        />
                      ) : (
                        ""
                      ...
                      <Row
                        label={t("PT_PROOF_IDENTITY_HEADER")}
                        text={`${(owner?.documents["proofIdentity"]?.name && getFixedFilename(owner.documents["proofIdentity"].name)) || "na"}`}
                        actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/proof-of-identity/`}${index}`} />}
                      />
                    </StatusTable>
                  </div>
                )}
        ...
        <StatusTable>
          {/* <Row
            ...
            actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/isResidential`} />}
          /> */}
          <Row
            label={t("PT_ASSESMENT1_PROPERTY_TYPE")}
            text={`${t(checkForNA(PropertyType?.i18nKey))}`}
            actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/property-type`} />}
          />
          {PropertyType?.code === "VACANT" && (
            <Row
              label={t("PT_ASSESMENT1_PLOT_SIZE")}
              text={`${landarea?.floorarea}`}
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/PtUnits`} />}
            />
          )}
          {PropertyType?.code !== "VACANT" &&
            units
          ...
          {/* {!isPropertyVacant(PropertyType?.i18nKey) && !isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/number-of-floors`} />}
            />
          )}
          {!isPropertyVacant(PropertyType?.i18nKey) && !isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/number-of-basements@0`} />}
            />
          )}
          {isPropertyVacant(PropertyType?.i18nKey) && !isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/area`} />}
            />
          )}
          {isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/floordetails`} />}
            />
          )}
          {isPropertyIndependent(PropertyType?.i18nKey) && (
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/floordetails/0`} />}
            />
          )} */}
        </StatusTable>
        {/* {!isPropertyVacant(PropertyType?.i18nKey) && isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
        ...
        {/* {!isPropertyVacant(PropertyType?.i18nKey) && isPropertyFlatorPartofBuilding(PropertyType?.i18nKey) && (
          <StatusTable>
            ...
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/is-this-floor-self-occupied`} />}
            />
            <Row
            ...
            {!isPropertyselfoccupied(selfOccupied?.i18nKey) && (
              <Row
                ...
                actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/rental-details`} />}
              />
            )}
            {!isPropertyselfoccupied(selfOccupied?.i18nKey) && (
              <Row
            ...
            {ispropertyunoccupied(IsAnyPartOfThisFloorUnOccupied?.i18nKey) && (
              <Row
                ...
                actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/un-occupied-area`} />}
              />
            )}
          </StatusTable>
        )} */}
              ...
              <div key={index}>
                ...
                <StatusTable>
                  <Row
                    ...
                    actionButton={
                      <ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/is-this-floor-self-occupied/`}${index}`} />
                    }
                  />
                  <Row
                    label={t("PT_BUILT_UP_AREA_LABEL")}
                    ...
                    actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/floordetails/`}${index}`} />}
                  />
                  {!isPropertyselfoccupied(units[index]?.selfOccupied?.i18nKey) && (
                    <Row
                      label={t("PT_PROPERTY_RENTED_AREA_LABEL")}
                      text={`${t(checkForNA(units[index]?.RentArea))} ${(units[index]?.RentArea && "sq.ft") || ""}`}
                      actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/rental-details/`}${index}`} />}
                    />
                  )}
                  {!isPropertyselfoccupied(units[index]?.selfOccupied?.i18nKey) && (
                    <Row
                  ...
                  {isPropertyPartiallyrented(units[index]?.selfOccupied?.i18nKey) && (
                    <Row
                      ...
                      actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/area/`}${index}`} />}
                    />
                  )}
                  {ispropertyunoccupied(units[index]?.IsAnyPartOfThisFloorUnOccupied?.i18nKey) && (
                    <Row
                      ...
                      actionButton={<ActionButton jumpTo={`${`/fsm-ui/citizen/pt/property/${typeOfApplication}/un-occupied-area/`}${index}`} />}
                    />
                  )}
                </StatusTable>
              </div>
            ...
            <div>
              ...
              <StatusTable>
                <Row
                  ...
                  actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/is-this-floor-self-occupied/-1`} />}
                />
                <Row
                  label={t("PT_BUILT_UP_AREA_LABEL")}
                  //text={`${t(checkForNA(units[0]?.builtUpArea))} ${(units[0]?.builtUpArea && "sq.ft") || ""}`}
                  text={`${t(checkForNA(units["-1"]?.builtUpArea))} ${(units["-1"]?.builtUpArea && "sq.ft") || ""}`}
                  actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/floordetails/-1`} />}
                />
                {!isPropertyselfoccupied(units["-1"]?.selfOccupied?.i18nKey) && (
                  <Row
                    label={t("PT_PROPERTY_RENTED_AREA_LABEL")}
                    text={`${t(checkForNA(units["-1"]?.RentArea))} ${(units["-1"]?.RentArea && "sq.ft") || ""}`}
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/rental-details/-1`} />}
                  />
                )}
                {!isPropertyselfoccupied(units["-1"]?.selfOccupied?.i18nKey) && (
                  <Row
                ...
                {isPropertyPartiallyrented(units["-1"]?.selfOccupied?.i18nKey) && (
                  <Row
                    ...
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/area/-1`} />}
                  />
                )}
                {ispropertyunoccupied(units["-1"]?.IsAnyPartOfThisFloorUnOccupied?.i18nKey) && (
                  <Row
                    ...
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/un-occupied-area/-1`} />}
                  />
                )}
              </StatusTable>
            </div>
            ...
            <div>
              ...
              <StatusTable>
                <Row
                  ...
                  actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/is-this-floor-self-occupied/-2`} />}
                />
                <Row
                  label={t("PT_BUILT_UP_AREA_LABEL")}
                  //text={`${t(checkForNA(units[0]?.builtUpArea))} ${(units[0]?.builtUpArea && "sq.ft") || ""}`}
                  text={`${t(checkForNA(units["-2"]?.builtUpArea))} ${(units["-2"]?.builtUpArea && "sq.ft") || ""}`}
                  actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/floordetails/-2`} />}
                />
                {!isPropertyselfoccupied(units["-2"]?.selfOccupied?.i18nKey) && (
                  <Row
                    label={t("PT_PROPERTY_RENTED_AREA_LABEL")}
                    text={`${t(checkForNA(units["-2"]?.RentArea))} ${(units["-2"]?.RentArea && "sq.ft") || ""}`}
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/rental-details/-2`} />}
                  />
                )}
                {!isPropertyselfoccupied(units["-2"]?.selfOccupied?.i18nKey) && (
                  <Row
                ...
                {isPropertyPartiallyrented(units["-2"]?.selfOccupied?.i18nKey) && (
                  <Row
                    ...
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/area/-2`} />}
                  />
                )}
                {ispropertyunoccupied(units["-2"]?.IsAnyPartOfThisFloorUnOccupied?.i18nKey) && (
                  <Row
                    ...
                    actionButton={<ActionButton jumpTo={`/fsm-ui/citizen/pt/property/${typeOfApplication}/un-occupied-area/-2`} />}
                  />
                )}
              </StatusTable>
            </div>
