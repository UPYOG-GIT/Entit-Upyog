...
const PTWFApplicationTimeline = (props) => {
  ...
  const getTimelineCaptions = (checkpoint) => {
    if (checkpoint.state === "OPEN") {
      ...
      return (
        <div>
          <Link to={`/fsm-ui/citizen/pt/property/properties/${props?.application?.propertyId}`}>
      ...
      case "PAY":
        return (
          ...
          <div style={{ marginTop: "1em", bottom: "0px", width: "100%", marginBottom: "1.2em" }}>
            <Link
              to={{ pathname: `/fsm-ui/citizen/payment/my-bills/${businessService}/${props.id}`, state: { tenantId: props.application.tenantId } }}
            >
        ...
        return (
          <div style={{ marginTop: "1em", bottom: "0px", width: "100%", marginBottom: "1.2em" }}>
            {businessService != "PT.MUTATION" && (
              <Link
                to={{
                  pathname: `/fsm-ui/citizen/pt/property/edit-application/action=edit-${businessService}/${props.id}`,
      ...
      case "SUBMIT_FEEDBACK":
        return (
          <div style={{ marginTop: "24px" }}>
            <Link to={`/fsm-ui/citizen/fsm/rate/${props.id}`}>
