  ...
  const inboxColumns = () => [
    {
      ...
      Cell: ({ row }) => {
        return (
          <div>
            <span className="link">
            <Link to={"/fsm-ui/employee/tl/application-details/" + row.original["applicationId"]}>{row.original["applicationId"]}</Link>
            </span>
          </div>
        );
      }
            ...
            allLinks={[
              {
                ...
                link: "/fsm-ui/employee/tl/new-application",
                businessService: "TL",
                roles: ["TL_CEMP"],
              },
              {
                text: "TL_SEARCH_APPLICATIONS",
                link: "/fsm-ui/employee/tl/search/application",
                businessService: "TL",
                roles: ["TL_FIELD_INSPECTOR","TL_APPROVER", "TL_DOC_VERIFIER","TL_CEMP"],
              },
              {
                text: "TL_SEARCH_LICENSE",
                link: "/fsm-ui/employee/tl/search/license",
                businessService: "TL",
              ...
              },
              {
                ...
                link: "/fsm-ui/employee/dss/dashboard/tradelicence",
                businessService: "TL",
                roles: ["STADMIN"],
              },
            ]}
