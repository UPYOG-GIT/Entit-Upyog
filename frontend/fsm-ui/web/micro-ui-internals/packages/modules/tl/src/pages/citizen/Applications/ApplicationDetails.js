            ...
            <div key={index} className="employee-data-table">
              ...
              {PTData?.Properties && PTData?.Properties.length > 0 && (
                <div>
                  ...
                  <LinkButton
                    ...
                    onClick={() => {
                      history.push(
                        `/fsm-ui/citizen/commonpt/view-property?propertyId=${PTData?.Properties?.[0]?.propertyId}&tenantId=${PTData?.Properties?.[0]?.tenantId}`
                      );
                    }}
                  ></LinkButton>
                </div>
             ...
             { !(PTData?.Properties && PTData?.Properties.length > 0 )&&<Row
              ...
              {application?.status === "CITIZENACTIONREQUIRED" ? (
                <Link
                  to={{
                    pathname: `/fsm-ui/citizen/tl/tradelicence/edit-application/${application?.applicationNumber}/${application?.tenantId}`,
                    state: {},
                  }}
                >
              ...
              {application?.status === "PENDINGPAYMENT" ? (
                <Link
                  to={{
                    pathname: `/fsm-ui/citizen/payment/collect/${application?.businessService}/${application?.applicationNumber}`,
