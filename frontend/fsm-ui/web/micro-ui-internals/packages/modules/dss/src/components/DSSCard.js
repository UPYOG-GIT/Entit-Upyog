...
const NDSSCard = () => {
  ...
  let links = Object.values(nationalScreenURLs)
    ...
    .map((obj) => ({
      label: t(obj?.label),
      link: `/fsm-ui/employee/dss/dashboard/${obj?.key}`,
    }));
  ...
  const propsForModuleCard = {
    ...
    subHeaderLink: `/fsm-ui/employee/payment/integration/dss/NURT_DASHBOARD`,
...
const DSSCard = () => {
  ...
  let links = Object.values(nationalScreenURLs)
    ...
    .map((obj) => ({
      label: t(obj?.label),
      link: obj.active?`/fsm-ui/employee/dss/dashboard/${obj?.stateKey}`:`/employee/integration/dss/${obj?.stateKey}`,
    }));
  ...
  const propsForModuleCard = {
    ...
    // subHeaderLink: `/fsm-ui/employee/payment/integration/dss/home`,
