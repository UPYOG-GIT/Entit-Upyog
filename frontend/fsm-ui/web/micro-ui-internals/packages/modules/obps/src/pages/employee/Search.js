...
const Search = ({ path }) => {
  ...
  useEffect(()=>{
    if (location.pathname === "/fsm-ui/citizen/obps/search/application" || location.pathname === "/fsm-ui/employee/obps/search/application") {
  ...
  if (
    ...
    if (Object.keys(payload).length === 0) {
      let payload1 = {
        ...
        ...(window.location.href.includes("/fsm-ui/citizen") && {
