...
const DesktopInbox = (props) => {
  ...
  const GetCell = (row) => <span className="link">
    <Link to={`/fsm-ui/citizen/obps/bpa/${encodeURIComponent(row.applicationId)}`}>{row?.applicationId}</Link>
  </span>;
    ...
    <div className="inbox-container">
        ...
        <div className="filters-container">
            ...
            allLinks={[
              {
                text: "OBPS_HOME",
                link: "/fsm-ui/citizen/obps/home",   
              },
              {
                text: "ES_COMMON_SEARCH_APPLICATION",
                link: "/fsm-ui/citizen/obps/search/application",
              },
            ]}
