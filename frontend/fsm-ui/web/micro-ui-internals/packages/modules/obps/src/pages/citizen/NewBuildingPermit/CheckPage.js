...
const CheckPage = ({ onSubmit, value }) => {
  ...
  function getdate(date) {
    ...
    let routeLink = `/fsm-ui/citizen/obps/bpa/${additionalDetails?.applicationType.toLowerCase()}/${additionalDetails?.serviceType.toLowerCase()}`;
    if (isEditApplication) routeLink = `/fsm-ui/citizen/obps/editApplication/bpa/${value?.tenantId}/${value?.applicationNo}`;
    if( sendbacktocitizenApp ) routeLink = `/fsm-ui/citizen/obps/sendbacktocitizen/bpa/${value?.tenantId}/${value?.applicationNo}`;
