...
const OBPSEmployeeHomeCard = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/fsm-ui/employee") {
    ...
    kpis: [
      {
        ...
        label: t("TOTAL_FSM"),
        link: `/fsm-ui/employee/obps/inbox`
      },
      {
        count: "-",
    ...
    links: [
      {
        ...
        link: `/fsm-ui/employee/obps/stakeholder-inbox`,
        field: "STAKEHOLDER"
      },
      {
      ...
      },
      {
        ...
        link: `/fsm-ui/employee/obps/search/application`
      },
      {
        count: isInboxLoading && isInboxLoadingOfStakeholder ? "" : directBhawanAnugya,
        label: t("Direct Bhawan Anugya"),
