...
const CheckPage = ({ onSubmit, value }) => {
  ...
  let routeLink = !isEditApplication?`/fsm-ui/citizen/obps/ocbpa/${additionalDetails?.applicationType.toLowerCase()}/${additionalDetails?.serviceType.toLowerCase()}`:`/fsm-ui/citizen/obps/editApplication/ocbpa/${value?.tenantId}/${value?.applicationNo}`;
