...
const MyApplication = () => {
  ...
  const getBPAREGFormData = (data) => {
    ...
    history.push("/fsm-ui/citizen/obps/stakeholder/apply/stakeholder-docs-required");
  };
    ...
    <Fragment>
      ...
      {finalData?.map((application, index) => {
        if (application.type === "BPAREG") {
          return (
            <Card key={index}>
              ...
              {application.status !== "INITIATED" ? (
                <Link to={{ pathname: `/fsm-ui/citizen/obps/stakeholder/${application?.applicationNumber}`, state: { tenantId: "" } }}>
          ...
          //     {application.status !== "INITIATED" ? <Link to={{ pathname: `/fsm-ui/citizen/obps/stakeholder/${application?.applicationNumber}`, state: { tenantId: '' } }}>
          //       <SubmitBar label={t("TL_VIEW_DETAILS")} />
          //     </Link> :
          ...
          return (
            <Card key={index}>
              ...
              {application.action === "SEND_TO_ARCHITECT" || application.status !== "INITIATED" ? (
                <Link to={{ pathname: `/fsm-ui/citizen/obps/bpa/${application?.applicationNo}`, state: { tenantId: "" } }}>
                  <SubmitBar label={t("TL_VIEW_DETAILS")} />
                </Link>
              ) : (
                <div>
