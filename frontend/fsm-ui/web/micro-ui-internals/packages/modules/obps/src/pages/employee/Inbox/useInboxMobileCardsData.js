...
const useInboxMobileCardsData = ({parentRoute, table, getRedirectionLink}) => {
    ...
    return ({ data:dataForMobileInboxCards,isTwoDynamicPrefix:true, linkPrefix: window.location.href.includes("/citizen") ?  `/fsm-ui/citizen/obps/` : `/fsm-ui/employee/obps/`,getRedirectionLink:getRedirectionLink, serviceRequestIdKey: "applicationNo", MobileSortFormValues})
