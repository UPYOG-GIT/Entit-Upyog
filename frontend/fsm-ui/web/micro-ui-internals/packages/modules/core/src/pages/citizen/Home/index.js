...
const Home = () => {
  ...
  // if (!tenantId) {
  //   history.push(`/fsm-ui/citizen/select-language`);
  // }

  if (!tenantId) {
    history.push(`/fsm-ui/citizen/fsm-home`);
  }
  ...
  const allCitizenServicesProps = {
    ...
    sideOption: {
      ...
      onClick: () => history.push("/fsm-ui/citizen/all-services"),
    },
    options: [
      {
        name: t("CS_COMMON_INBOX_BPA"),
        Icon: <OBPSIcon />,
        onClick: () => history.push("/fsm-ui/citizen/obps-home"),
      },
      {
        name: t("ES_PGR_HEADER_COMPLAINT"),
        Icon: <ComplaintIcon />,
        onClick: () => history.push("/fsm-ui/citizen/pgr-home"),
      },
      // {
      //   name: t("MODULE_PT"),
      //   Icon: <PTIcon className="fill-path-primary-main" />,
      //   onClick: () => history.push("/fsm-ui/citizen/pt-home"),
      // },
      // {
      //   name: t("MODULE_TL"),
      //   Icon: <CaseIcon className="fill-path-primary-main" />,
      //   onClick: () => history.push("/fsm-ui/citizen/tl-home"),
      // },
      // {
      //     name: t("ACTION_TEST_WATER_AND_SEWERAGE"),
      //     Icon: <DropIcon/>,
      //     onClick: () => history.push("/fsm-ui/citizen")
      // },
  ...
  const allInfoAndUpdatesProps = {
    ...
    options: [
      ...
      //   Icon: <Calender />,
      //   onClick: () => history.push("/fsm-ui/citizen/engagement/events"),
      // },
      // {
      //   name: t("CS_COMMON_DOCUMENTS"),
      //   Icon: <DocumentIcon />,
      //   onClick: () => history.push("/fsm-ui/citizen/engagement/docs"),
      // },
      {
        name: t("CS_COMMON_SURVEYS"),
        Icon: <DocumentIcon />,
        onClick: () => history.push("/fsm-ui/citizen/engagement/surveys/list"),
      },
      // {
        ...
        EventsDataLoading ? (
          ...
          <div className="WhatsNewSection">
            <div className="headSection">
              ...
              <p onClick={() => history.push("/fsm-ui/citizen/engagement/whats-new")}>{t("DASHBOARD_VIEW_ALL_LABEL")}</p>
            </div>
