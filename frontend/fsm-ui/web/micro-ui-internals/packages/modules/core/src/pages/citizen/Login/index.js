...
const Login = ({ stateCode, isUserRegistered = true }) => {
    ...
    if (isUserRegistered) {
      ...
      if (!err) {
        ...
        if (!(location.state && location.state.role === "FSM_DSO")) {
          history.push(`/fsm-ui/citizen/register/name`, {
            from: getFromLocation(location.state, searchParams),
            data: data,
          });
        }
  ...
  function onSubmit() {
    ...
    if (selectedCity) {
      Digit.SessionStorage.set("CITIZEN.COMMON.HOME.CITY", selectedCity);
      history.push("/fsm-ui/citizen/obps-home");
    } else {
      setShowError(true);
    }
  }
        ...
        <div>
          <form>
            ...
            >
              ...
              {location.pathname === "/fsm-ui/citizen/register/name" && (
              ...
              {location.pathname === "/fsm-ui/citizen/login/otp" || location.pathname === "/fsm-ui/citizen/register/otp" ? (
                <>
                  <TextField
                    fullWidth
                    required
              ...
              {location.pathname === "/fsm-ui/citizen/login" ? (
                <Button
                  fullWidth
                  variant="contained"
