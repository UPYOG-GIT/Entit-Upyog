    ...
    const PropertyDetail = {
      ...
      values: [
        ...
        { title: "PROPERTY_ADDRESS", value: propertyAddress || "NA" },
        {
          ...
          to: `/fsm-ui/employee/commonpt/view-property?propertyId=${propertyDetails?.Properties?.[0]?.propertyId}&tenantId=${propertyDetails?.Properties?.[0]?.tenantId}&from=TL_APPLICATION_DETAILS_LABEL`,
          value: "",
          isLink: true,
        },
      ],
