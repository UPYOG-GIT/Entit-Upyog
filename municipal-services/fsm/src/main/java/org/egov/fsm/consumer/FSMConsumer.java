...
import org.egov.fsm.service.notification.WhatsappNotification;
...
public class FSMConsumer {
	...
	public void listen(final HashMap<String, Object> record, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic) {
		...
		log.info("FSM Received: " + fsmRequest.getFsm().getApplicationNo());
//		 notificationService.process(fsmRequest);
		whatsappNotification.sendWhatsappMessage(fsmRequest);
	}
}